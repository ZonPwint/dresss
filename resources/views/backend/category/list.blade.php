          ...
          <div class="card">
            <div class="card-header">
              <div class="d-flex align-items-center">
                ...
                <a class="btn btn-primary btn-round ms-auto" href="{{ route('category.create') }}">
                    ...
                    @foreach($categories as $category)
                      ...
                      <tr>
                        ...
                        <a href="{{ route('category.edit',$id) }}" class="btn btn-warning">
                          ...
                          <form class="d-inline-block" action="{{ route('category.destroy',$id) }}" method="POST" onsubmit="return confirm('Are you sure want to delet?')">
                            @csrf
                            @method('DELETE')
